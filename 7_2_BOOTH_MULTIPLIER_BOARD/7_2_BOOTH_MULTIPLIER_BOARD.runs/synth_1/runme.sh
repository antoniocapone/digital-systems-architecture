...
HD_PWD='C:/Xilinx/Projects/7_2_BOOTH_MULTIPLIER_BOARD/7_2_BOOTH_MULTIPLIER_BOARD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log booth_multiplier_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source booth_multiplier_onboard.tcl
