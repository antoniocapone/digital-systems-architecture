...
HD_PWD='C:/Xilinx/Projects/7_2_BOOTH_MULTIPLIER_BOARD/7_2_BOOTH_MULTIPLIER_BOARD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log booth_multiplier_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source booth_multiplier_onboard.tcl -notrace
