...
HD_PWD='C:/Xilinx/Projects/5_2_CHRONOMETER_BOARD/5_2_CHRONOMETER_BOARD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chronometer_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chronometer_onboard.tcl -notrace
