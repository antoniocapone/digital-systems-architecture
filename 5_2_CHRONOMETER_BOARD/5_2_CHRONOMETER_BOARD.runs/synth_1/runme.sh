...
HD_PWD='C:/Xilinx/Projects/5_2_CHRONOMETER_BOARD/5_2_CHRONOMETER_BOARD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chronometer_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chronometer_onboard.tcl
