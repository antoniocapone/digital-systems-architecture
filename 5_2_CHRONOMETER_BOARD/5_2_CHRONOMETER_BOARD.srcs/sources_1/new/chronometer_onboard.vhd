...
-- menti nel formato HH.MM.SS. L'intervallo supportato è [00.00.00; 23.59.59]. Arrivato
-- all'estremo superiore, il cronometro ripartirà dall'inizio. 
-- Per impostare un valore personalizzato, si utilizzano gli switches e i pulsanti.
-- Precisamente, si inserisce il valore in notazione binaria posizionale, su sei bit per
-- i minuti e i secondi e su cinque bit per le ore, utilizzando gli switches partendo da
-- destra. Per memorizzare il valore dei secondi si preme il pulsante di destra, per i
-- minuti quello centrale, e quello di sinistra per le ore. I valori non validi (e.g. 63
-- secondi) verranno azzerati. Per visualizzare il valore memorizzato si preme il tasto
-- in basso. Il pulsante in alto è di reset.
