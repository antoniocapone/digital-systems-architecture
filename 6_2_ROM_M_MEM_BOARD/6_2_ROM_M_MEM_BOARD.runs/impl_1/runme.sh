...
HD_PWD='C:/Xilinx/Projects/6_2_ROM_M_MEM_BOARD/6_2_ROM_M_MEM_BOARD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_m_mem_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_m_mem_onboard.tcl -notrace
