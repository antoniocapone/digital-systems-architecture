...
HD_PWD='C:/Xilinx/Projects/6_2_ROM_M_MEM_BOARD/6_2_ROM_M_MEM_BOARD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_m_mem_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_m_mem_onboard.tcl
