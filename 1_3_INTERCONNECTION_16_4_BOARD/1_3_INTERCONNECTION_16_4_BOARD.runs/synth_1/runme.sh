...
HD_PWD='C:/Xilinx/Projects/1_3_INTERCONNECTION_16_4_BOARD/1_3_INTERCONNECTION_16_4_BOARD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnection16_4_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interconnection16_4_onboard.tcl
