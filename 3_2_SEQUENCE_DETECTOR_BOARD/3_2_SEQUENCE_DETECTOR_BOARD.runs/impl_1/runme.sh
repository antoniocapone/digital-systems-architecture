...
HD_PWD='C:/Xilinx/Projects/3_2_SEQUENCE_DETECTOR_BOARD/3_2_SEQUENCE_DETECTOR_BOARD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sequence_Detector_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sequence_Detector_onboard.tcl -notrace
