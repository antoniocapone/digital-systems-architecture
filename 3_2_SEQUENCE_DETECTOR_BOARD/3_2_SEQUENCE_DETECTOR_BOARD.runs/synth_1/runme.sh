...
HD_PWD='C:/Xilinx/Projects/3_2_SEQUENCE_DETECTOR_BOARD/3_2_SEQUENCE_DETECTOR_BOARD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sequence_Detector_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sequence_Detector_onboard.tcl
