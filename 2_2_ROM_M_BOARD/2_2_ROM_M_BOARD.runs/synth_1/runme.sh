...
HD_PWD='C:/Xilinx/Projects/2_2_ROM_M_BOARD/2_2_ROM_M_BOARD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S_onboard.tcl
