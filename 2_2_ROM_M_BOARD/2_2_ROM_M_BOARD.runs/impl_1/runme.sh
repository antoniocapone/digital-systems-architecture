...
HD_PWD='C:/Xilinx/Projects/2_2_ROM_M_BOARD/2_2_ROM_M_BOARD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S_onboard.tcl -notrace
