...
-- sinistra a destra.
-- Nota: la netlist mostra come nel design sintetizzato uno degli switch venga ignorato.
-- Questo poiché la ROM contiene dati duplicati, di conseguenza l'output sarà lo stesso
-- indipendentemente dal MSB, che viene dunque ignorato.
